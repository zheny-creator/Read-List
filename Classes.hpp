...
#include <vector>        // Для работы с динамическими массивами (в данном коде пока не используется)
#include <string>        // Для работы со строками (в данном коде пока не используется)
